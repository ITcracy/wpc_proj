    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('twitter_block', wagtail.core.fields.StreamField((('twitter', wagtail.core.blocks.StructBlock((('twitter_box_username', wagtail.core.blocks.CharBlock(help_text='Username or the Screenname of the twitter handle.', required=True, verbose_name='Username')), ('twitter_box_tweet_limit', wagtail.core.blocks.CharBlock(default=2, help_text='Max number of tweets to be displayed on the homepage.', max_length=2, required=True, verbose_name='Tweets limit'))))),), blank=True, help_text='Title to displayed for blog section.', null=True, verbose_name='Twitter Link')),
